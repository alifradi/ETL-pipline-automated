...
def get_data(base_url, package_id):
    # To retrieve the metadata for this package and 
    #its resources, use the package name in this page's URL:
    ...
    # Combine all dataframes in data_list into a 
    # single dataframe if data_list is not empty
    if data_list:
